...
public class ShipmentEvent {
    ...
    public ShipmentEvent(OrderShipment shipment, String key, String status, String substatus, Instant occurredAt, Instant now) {
        ...
        this.providerShipmentId = Objects.requireNonNull(shipment.getProviderShipmentId());
    ...
    public Instant getOccurredAt() { return occurredAt; } public Long getProviderShipmentId() { return providerShipmentId; }
}
