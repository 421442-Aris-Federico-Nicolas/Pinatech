...
public class ProductVariant {
    ...
    public ProductVariant(Product product, String colorName, String colorHex, Long imageId, int displayOrder) {
        this.product = product;
        update(colorName, colorHex, imageId, displayOrder);
    }

    public void update(String colorName, String colorHex, Long imageId, int displayOrder) {
    ...
    public void deactivate() { active = false; imageId = null; }
