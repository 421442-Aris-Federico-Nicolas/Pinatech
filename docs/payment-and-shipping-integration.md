...
Mercado Pago Checkout Pro and manually reviewed bank transfers are implemented. Delivery quoting is not implemented yet.
...
Order creation, payment approval, transfer rejection and physical delivery enqueue email in the
