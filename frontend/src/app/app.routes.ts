...
export const routes: Routes = [
  ...
  { path: 'admin', title: 'Administración', canActivate: [authGuard, adminGuard], canDeactivate: [unsavedAdminGuard], loadComponent: () => import('./features/admin/admin.component').then((component) => component.AdminComponent) },
  {
    path: '**',
